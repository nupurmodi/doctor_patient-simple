...
<body>
  <div id="main">
    ...
    <form method="post" class="form_settings" name="myForm2" onsubmit="return validateform()" action="fetchdb.php">
	...
	<p style="margin-top:9px;margin-left:9px;text-align:left;">Haven't registered yet?<a href="signup.php"><i><u>signup</u></i></p>
</div>
</div>
