...
<body>
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          <li class="selected"><a href="admin_welcome.php">My details</a></li>
	...
	<h1 style="text-align:center;"><strong>Add Doctors</strong></h1>

	<?php
include("mysqlcon.php");
   $query="SELECT * FROM doctor_dummy ";
 ...
 $stime=date('h:i A',strtotime($row['start_time']));
  ...
  ?>
    <div style="min-height:250px;width:400px;border:2px ridge #025587 ;border-radius:15%;margin-left:200px;margin-top:10px;padding-top:20px;padding-left:50px;font-size:15px">
		...
		<form name="edit" action="insdoctor_org.php"method="post" class="form_settings" >
				<input type="hidden" name="id" value="<?php echo $row['doctor_id']?>" />
				 <button name="allow" type="submit" class="submit"  value="allow" style="margin-left:15%;margin-bottom:10px;float:left;"> ALLOW</button>
				 <button name="deny" type="submit" class="submit"  value="deny" style="margin-left:15%;margin-bottom:10px;"> Deny</button>
				 </form>
